package cloverOrder.src.main.java.inMaven.V2WebPayTest.src.com.company;
...
public class Main {
  ...
  static final String MERCHANT_ID = "263E8B8MBKAE1";
  static final String ACCESS_TOKEN = "7f85179c-2902-3c34-6515-b3339024922a";

  // Test Credit Card Info
  //static final String CC_NUMBER = "6011361000006668";
  static final String CC_NUMBER = "4005571702222222";
  
  static final String CVV_NUMBER = "123";
  static final int EXP_MONTH = 1;
  static final int EXP_YEAR = 2021;
